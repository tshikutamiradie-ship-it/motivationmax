        ...
        <div className="bg-[#111] border border-white/10 rounded-2xl p-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div>
              ...
              <input value={password} onChange={e => setPassword(e.target.value)} type="password" placeholder="••••••••" onKeyDown={e => e.key === 'Enter' && login()} className="w-full px-4 py-3 rounded-xl border border-white/10 bg-white/5 text-sm text-white placeholder-gray-500 outline-none" />
            </div>
            {error && (
